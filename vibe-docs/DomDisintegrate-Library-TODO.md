# DOM Disintegrate Library — TODO

> Pick up after reading `vibe-docs/DomDisintegrate-Library-Design.md`.

## Phase 1 — Scaffold package

- [ ] Create `packages/dom-disintegrate/` with `package.json`, `tsconfig`, Vitest
...
- [ ] Move `src/shared/ui/effects/domDisintegrate/**` → package `src/`
...
- [ ] Shim `src/shared/ui/effects/domDisintegrate/index.ts` to re-export package
